...
export default function AddEditTask({column, addTask, updateTask, task, setShowModal}) {
    ...
    return <BoxModal open>
        ...
        <section className="task-form">
            ...
            <LocalizationProvider dateAdapter={AdapterDayjs}>
                <DatePicker disablePast={true} value={dayjs(deadline)} onChange={v => setDeadline(v.toString())}/>
